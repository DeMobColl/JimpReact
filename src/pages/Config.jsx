        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
          ...
          <form onSubmit={handlePasswordSubmit}>
            ...
            <div className="flex gap-3">
              ...
              <button
                type="submit"
                className="flex-1 px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                disabled={verifying}
              >
                {verifying ? (
                  <>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          {showChangePassword && (
            <form onSubmit={handleChangePasswordSubmit} className="mt-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg space-y-4">
              ...
              <button
                type="submit"
                className="w-full px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={saving}
              >
