    ...
    <>
      <div className="flex items-center justify-center h-full bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/50 dark:from-gray-900 dark:via-gray-900 dark:to-slate-900 px-4 py-2 transition-colors duration-300">
        ...
        <h1 className="text-xl md:text-2xl font-bold text-slate-800 dark:text-slate-100 mb-1.5">
          ...
          {currentUser && (
            <span>
              , <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-500 dark:from-blue-400 dark:to-indigo-400">{currentUser.name}</span>
            </span>
          )}
        </h1>
        ...
        {isAdmin && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 mb-3">
            ...
            {/* <Link
              to="/config"
              className="bg-gradient-to-br from-amber-50/80 to-orange-50/80 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl p-2 border border-amber-200/60 dark:border-amber-700/60 hover:shadow-lg hover:shadow-amber-200/50 dark:hover:shadow-none hover:scale-105 transition-all duration-200 cursor-pointer"
            >
              <div className="flex items-center justify-center mb-1">
        ...
        <div className="flex justify-center mb-2">
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white rounded-xl shadow-xl shadow-emerald-200/50 hover:shadow-2xl hover:shadow-emerald-300/50 dark:shadow-emerald-900/30 dark:hover:shadow-emerald-800/40 hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2"
          >
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {import.meta.env.VITE_DEV_WHATSAPP && (
              <a
                ...
                className="px-5 py-2.5 text-xs font-medium bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-xl shadow-md hover:shadow-lg hover:shadow-green-200/50 dark:hover:shadow-none transition-all duration-200 flex items-center justify-center gap-2"
              >
            ...
            {import.meta.env.VITE_DEV_EMAIL && (
              <a
                ...
                className="px-5 py-2.5 text-xs font-medium bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white rounded-xl shadow-md hover:shadow-lg hover:shadow-blue-200/50 dark:hover:shadow-none transition-all duration-200 flex items-center justify-center gap-2"
              >
