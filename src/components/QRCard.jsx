        ...
        <div className="flex-1 overflow-y-auto p-6 pt-4">
          ...
          <div className="flex gap-2 mb-4">
            <button
              ...
              className={`flex-1 px-4 py-2 rounded-lg font-semibold transition-all ${selectedType === 'simple'
            ...
            <button
              ...
              className={`flex-1 px-4 py-2 rounded-lg font-semibold transition-all ${selectedType === 'submit'
